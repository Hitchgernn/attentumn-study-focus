...
const FocusReport: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-6 lg:p-8 relative overflow-hidden">
      <BrandBar />
      <div
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="bg-white/50 border border-white/25 rounded-3xl shadow-2xl backdrop-blur-xl p-6 lg:p-10 mt-16">
          {/* Header */}
